...
describe('toOlistDateParam', () => {
  it('formats a UTC timestamp still within the same local calendar day', () => {
    ...
    expect(toOlistDateParam(new Date('2026-08-12T23:30:00Z'))).toBe('2026-08-12')
  })
  ...
  it('does not roll forward to the UTC date when local date is still the previous day', () => {
    ...
    expect(toOlistDateParam(new Date('2026-08-13T01:00:00Z'))).toBe('2026-08-12')
  })
})
